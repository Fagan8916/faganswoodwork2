...
import ashBowtieMain from "@/assets/gallery/ash-bowtie-main.png";
...
export const galleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    description: "This piece has survived something. A deep split runs through the ash - the kind that happens when wood moves, when seasons change, when a tree falls and nature starts to reclaim it. Rather than cut our losses, we chose repair.\n\nThree bow tie inlays in warm Sapele wood cross the crack like stitches - functional, deliberate, and unexpectedly beautiful. Between them, we've filled the remaining void with a forest green epoxy that settles into the grain. The result isn't a lazy Susan that's been fixed - it's one that's been transformed.\n\nThe bow ties aren't just structural. They're a design choice. A reminder that damage doesn't mean diminished - it means character. Every time you lift it onto a table and give it a turn, you're holding something that was broken and made better.\n\nFinished with Rubio Monocot hardwax oil.",
    specs: {
      pieceType: "Lazy Susan",
